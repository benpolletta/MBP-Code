function [AVP_all]=run_Satvinder_temp(subject,channel,phase_freq,norm_flag) % all_avg_fft,all_avg_se,MI_all,MI_all_thresh,
...
if isempty(phase_freq)
    tic; [AVP_all]=wavelet_mouse_eeg_collect_AVP_preferred_thresh(epoch_list,condition_dirs,norm_flag); toc;
else
    tic; [AVP_all]=wavelet_mouse_eeg_collect_AVP(epoch_list,condition_dirs,phase_freq,norm_flag); toc;
end
