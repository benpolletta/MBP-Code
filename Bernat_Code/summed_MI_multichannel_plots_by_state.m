function summed_MI_multichannel_plots_by_state
...
for zs = 1:no_zs
    ...
    for n = 1:no_norms
        ...
        for p = 1:no_pds
            ...
            suffix = [zs_labels{zs}, norms{n}, periods{p}, '_', mat_labels{1}];
            
            ranksum_suffix = [zs_labels{zs}, norms{n}, periods{p}, '_', mat_labels{1}, '_ranksum'];
                ...
                for b = 1:no_bands
                    ...
                    for state = 1:no_states
                        ...
                        for s = 1:2
                            ...
                            tit_le = {[drugs{d}, ', ', state_labels{state}];[long_stat_labels{s}, ' MI, by ',long_zs{zs}, long_norms{n}]};
