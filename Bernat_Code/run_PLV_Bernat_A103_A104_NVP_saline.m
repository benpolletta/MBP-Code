function run_PLV_Bernat_A103_A104_NVP_saline(no_shufs,chan1_channels,chan2_channels)
...
for s = 3:4 % 1:min(length(chan1_channels),length(chan2_channels))
