function collect_MI_Bernat_by_state

present_dir=pwd;

[listname,listpath]=uigetfile('*by_state.list','Choose a list of files to collect modulation index.');
...
for i=1:subj_num
    ...
    [periods,states]=textread(char(epoch_files(i)),'%*d%s%s%*[^\n]');
