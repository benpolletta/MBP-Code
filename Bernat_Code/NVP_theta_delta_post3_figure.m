function NVP_theta_delta_post3_figure
...
for ch = 1:2
    ...
    for band = 1:2
        ...
        BP2 = BP(strcmp(Frontal_BP_hrs, 'post3') & strcmp(Frontal_BP_drugs, 'NVP'), band, ch);
        ...
        set(gca, 'XTick', bar_pos(:, 1)', 'XTickLabel', [1 3])
...
save_as_pdf(gcf, 'NVP_theta_delta_post3')
