function NVP_theta_delta_postn_figure(hour_post)
...
short_BP_6min_labels = (1:(no_post*10))*6 - 3; short_BP_6min_labels(short_BP_6min_labels == 0) = [];
...
for ch = 1:2
    ...
    for band = 1:2
        ...
        BP2 = BP(strcmp(Frontal_BP_hrs, sprintf('post%d', hour_post)) & strcmp(Frontal_BP_drugs, 'NVP'), band, ch);
        ...
        set(gca, 'XTick', bar_pos(:, 1)', 'XTickLabel', [1 hour_post])
...
save_as_pdf(gcf, sprintf('NVP_theta_delta_post%d', hour_post))
