function PLV_multichannel_plots_w_time_series_by_state
...
All_cplot_data = nan(length(freqs), no_drugs, no_hr_periods, no_stats, no_chan_pairs, no_norms);
...
for n=1:no_norms
    ...
    for c=1:no_chan_pairs
        ...
        data_length = min(size(spec_stats, 3), no_hr_periods);
