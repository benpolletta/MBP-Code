...
stats_collected_BP_by_3_categories([name,'/',name,'_BP_hrs_state_vs_W'],{band_freq_labels, long_band_freq_labels},...
    {drug_labels, drug_labels},{state_labels, state_labels},{short_hr_labels, hr_labels},drugs,states,hrs,BP)
...
stats_collected_BP_by_3_categories([name,'/',name,'_BP_pct_hrs_state_vs_W'],{band_freq_labels, long_band_freq_labels},...
    {drug_labels, drug_labels},{state_labels, state_labels},{short_hr_labels, hr_labels},drugs,states,hrs,BP_pct)

stats_collected_BP_by_3_categories([name,'/',name,'_BP_pct_by_state_hrs_state_vs_W'],{band_freq_labels, long_band_freq_labels},...
    {drug_labels, drug_labels},{state_labels, state_labels},{short_hr_labels, hr_labels},drugs,states,hrs,BP_pct_by_state)
...
stats_collected_BP_by_3_categories([name,'/',name,'_BP_6min_state_vs_W'],{band_labels, band_labels},...
    {drug_labels, drug_labels},{state_labels, state_labels},{pd_labels, pd_labels},drugs,states,sixmins,BP)
...
stats_collected_BP_by_3_categories([name,'/',name,'_BP_pct_6min_state_vs_W'],{band_labels, band_labels},...
    {drug_labels, drug_labels},{state_labels, state_labels},{pd_labels, pd_labels},drugs,states,sixmins,BP_pct)

stats_collected_BP_by_3_categories([name,'/',name,'_BP_pct_by_state_6min_state_vs_W'],{band_labels, band_labels},...
    {drug_labels, drug_labels},{state_labels, state_labels},{pd_labels, pd_labels},drugs,states,sixmins,BP_pct_by_state)
