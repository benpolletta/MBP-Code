    ...
    for c=1:length(channels)
        ...
        for s=1:length(stats)
            ...
            for st=1:length(states)
                ...
                saveas(gcf,[channel_name,'/',measure_name,'_MI_horiz_',sub_labels{sub},'_',states{st},'_',stats{s},'.fig'])
                set(gcf,'PaperOrientation','landscape','PaperUnits','normalized','PaperPosition',[0 0 1 1])
                print(gcf,'-dpdf',[channel_name,'/',measure_name,'_MI_horiz_',sub_labels{sub},'_',states{st},'_',stats{s},'.pdf'])
    ...
    for d=1:4
        ...
        for s=1:length(stats)
            ...
            for st=1:length(states)
                ...
                saveas(gcf,['ALL_',drugs{d},'_MI_horiz_',sub_labels{sub},'_',states{st},'_',stats{s},'.fig'])
                set(gcf,'PaperOrientation','landscape','PaperUnits','normalized','PaperPosition',[0 0 1 1])
                print(gcf,'-dpdf',['ALL_',drugs{d},'_MI_horiz_',sub_labels{sub},'_',states{st},'_',stats{s},'.pdf'])
    ...
    for c=1:length(channels)
        ...
        for s=1:length(stats)
            ...
            for st=1:length(states)
                ...
                open(['ALL_',channels{c},'/ALL_',channels{c},'_p0.99_IEzs_MI_horiz_',sub_labels{sub},'_',states{st},'_',stats{s},'.fig'])
    ...
    for d=1:4
        ...
        for s=1:length(stats)
            ...
            for st=1:length(states)
                ...
                open(['ALL_',drugs{d},'_MI_horiz_',sub_labels{sub},'_',states{st},'_',stats{s},'.fig'])
