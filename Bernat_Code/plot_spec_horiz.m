...
for i=1:4, xlabels{i}='Time Since Injection (h)'; ylabels{i}='Frequency (Hz)'; end
...
%             figure_replotter_labels(1:4,4,1,8,6,[(-40*6:6:0)+3,(0:6:12*10*6)-3],freqs,titles,xlabels,ylabels)
            figure_replotter_labels_subregion(1:4,4,1,8,5.0001,[(-40*6:6:0)+3,(0:6:12*10*6)-3]/60,freqs,[-2 6],[0 200],titles,xlabels,ylabels)
