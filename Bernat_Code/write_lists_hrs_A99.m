...
%     hour_labels{d}=drug_hour_labels;
    ...
    write_lists_Bernat_Aug('A99',channels,'hours_by_state','drugs',drugs{d},'periods',drug_hours,'pd_labels',drug_hour_labels)
    write_lists_Bernat_Aug('A99',channels,'hours','drugs',drugs{d},'periods',drug_hours,'pd_labels',drug_hour_labels,'states',[])
