function write_epochs_A105_Ro25
...
%     channel_data=getfield(data,['Ch',num2str(channels(c)+8)]); 
    channel_name=fieldnames{9-channels(c)}
    channel_data=getfield(data,channel_name);
