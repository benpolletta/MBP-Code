function emd_bMI_plotter_missing_F_MI(challenge_list,challenge_fig_list,challenge_name,challenge_descriptor,challenge_params,challenge_labels)
...
for i=1:listnum
    ...
    [All_bMI,avg_bMI]=batch_bMI_missing_F_MI(listname,figlistname,4,'FFT\Filter_Bank_Divisor_2\MI_Data_Plots','FFT\Filter_Bank_Divisor_2\HAF_Data_Plots',[3 9],15,[20 110],15,2,'Hz');
