function fft_Satvinder_control_analysis_reflect
...
%             tic;
            ...
            [~,~,temp_MI(:,:,:,1),temp_MI(:,:,:,2),temp_MI(:,:,:,3),temp_MI(:,:,:,4),temp_MI(:,:,:,5)]=CFC_April_fft_reflect(char(filenames(k)),600,20,100,.05,.05,[4 12],no_bands_lo,[20 110],no_bands_hi,order,pct_pass,'Hz',dirnames,[],[]);
