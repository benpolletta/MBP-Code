...
[Fbank_filename,Fbank_pathname]=uigetfile('*sigs.txt','Choose Fbank Modes');

modes=load([Fbank_pathname,Fbank_filename]);
[mode_length,no_modes]=size(modes);
...
[EMD_filename,EMD_pathname]=uigetfile('*modes.txt','Choose EMD Modes');
