function fft_sim_analysis_1Hz_bw

set(0,'DefaultFigureVisible','off')

orders=[-1 3];
challenge_list='noise_master.list';
challenge_name='noise';
challenge_descriptor='Noise';
challenge_params=[1:10]*.1;

bands_lo_in=[linspace(3.2,8.8,15)-1; linspace(3.2,8.8,15); linspace(3.2,8.8,15)+1]';
bands_hi_in=[linspace(23,107,15)-5; linspace(23,107,15); linspace(23,107,15)+5]';
...
%             tic;
            ...
            [bands_lo,bands_hi,MI(:,:,k,1),MI(:,:,k,2),MI(:,:,k,3),MI(:,:,k,4),MI(:,:,k,5)]=CFC_April_fft_10_2013(char(filenames(k)),600,20,100,.05,.05,[3 9],15,[20 110],15,order,pct_pass,'Hz',dirnames,bands_lo_in,bands_hi_in);
