...
filenames=textread(['asym_',num2str(asym(j)),'.hht.list'],'%s%*[^\n]');
...
figure()
colorplot(avgpMI(:,:,:))
title(['Mean Percent Modulation Index, Asymmetry Index ',num2str(asym(j))])
axis xy
...
title(['Histogram of Max. Amplitude Bin for ',graph_titles{4},', Asymmetry Index ',num2str(asym(j))])
...
title(['Histogram of Max. Phase Bin for ',graph_titles{4},', Asymmetry Index ',num2str(asym(j))])
