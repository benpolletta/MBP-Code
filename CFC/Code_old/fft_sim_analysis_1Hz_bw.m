...
bands_lo=[linspace(3.2,8.8,15)-1; linspace(3.2,8.8,15); linspace(3.2,8.8,15)+1]';
no_bands_lo=length(bands_lo);
bands_hi=[linspace(23,107,15)-3; linspace(23,107,15); linspace(23,107,15)+3]';
...
%             tic;
            ...
            [~,~,temp_MI(:,:,:,1),temp_MI(:,:,:,2),temp_MI(:,:,:,3),temp_MI(:,:,:,4),temp_MI(:,:,:,5)]=CFC_April_fft_10_2013(char(filenames(k)),600,20,100,.05,.05,[3 9],15,[20 110],15,order,pct_pass,'Hz',dirnames,bands_lo,bands_hi);
