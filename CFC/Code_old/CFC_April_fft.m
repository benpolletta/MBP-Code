function [bands_lo,bands_hi,MI,MI_p_vals,MI_z_scores,Percent_MI,MI_z_thresh]=CFC_April_fft(datafile,sampling_freq,nobins,noshufs,p_threshold,z_threshold,range_lo,nobands_lo,range_hi,nobands_hi,buttorder,pct_pass,units,outfilename,dirname)
...
%     fft_inv_entropy_pMI_all(MI_z_thresh,F_hi,F_lo,50,spacing,units,dataname);
    Percent_MI=fft_inv_entropy_plot_pMI(MI_z_thresh,F_hi,F_lo,range_lo,nobands_lo,range_hi,nobands_hi,units,dataname);
...
%     fft_inv_entropy_pMI_all(MI_p_thresh,F_hi,F_lo,50,spacing,units,dataname);
    Percent_MI=fft_inv_entropy_plot_pMI(MI_p_thresh,F_hi,F_lo,range_lo,nobands_lo,range_hi,nobands_hi,units,dataname);
else
    fft_inv_entropy_plot_scatter(MI,F_hi,F_lo,units,dataname)
%     fft_inv_entropy_pMI_all(MI,F_hi,F_lo,50,spacing,units,dataname);
    Percent_MI=fft_inv_entropy_plot_pMI(MI,F_hi,F_lo,range_lo,nobands_lo,range_hi,nobands_hi,units,dataname);
end
