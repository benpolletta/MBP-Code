function emd_sim_analysis_reflect

set(0,'DefaultFigureVisible','off')

% challenge_list='p_noise_hht_test_master.list';
% challenge_name='p_noise_hht_test';
challenge_list='noise_reflected_hht_master.list';
challenge_name='noise_reflect';
challenge_descriptor='Noise';
...
graph_labels={'MI';'PV';'ZS';'BMI';'BMIpt';'BMIzt'};
...
%         filename=[filename,'_low_hi.txt'];
        [bands,MI(:,:,1),MI(:,:,2),MI(:,:,3),nMI(:,:,k,1),nMI(:,:,k,2),nMI(:,:,k,3)]=CFC_April_emd_beta(filename,600,5,20,100,.05,.05,[3 9],15,[20 110],15,'linear','Hz',dirnames);
