function fbank_sim_analysis(challenge_list,challenge_name,challenge_descriptor,challenge_params,challenge_labels)
...
for m=1:2
    ...
    for j=1:no_challenges
        ...
        for k=1:filenum
            ...
            [bands,MI(:,:,1),MI(:,:,2),MI(:,:,3),nMI(:,:,k,1),nMI(:,:,k,2)]=CFC_April_fbank(char(filenames(k)),600,5,20,100,.05,.05,[3 9],15,[20 110],15,0,.9,divisor,'Hz',dirnames);
