function [All_bMI,avg_bMI]=batch_bMI_missing_F_MI(datalist,figlist,charstoskip,MI_dir,F_dir,x_lims,x_bins,y_lims,y_bins,spacing,units)
...
for i=1:filenum
    ...
    [f,data_hat,bands,signals,H,A,P,F,cycle_bounds]=filter_fft_bank(data,600,5,10,[1/signal_length 300],spacing,0,.9,filename,filename);
