function [All_bMI,avg_bMI]=batch_bMI_missing_MI(datalist,figlist,charstoskip,MI_dir,F_dir,x_lims,x_bins,y_lims,y_bins,spacing,units)
...
for i=1:filenum
    ...
    Ffilename=[filename,'\',filename,'_freqs.txt'];
    F=load(Ffilename);
