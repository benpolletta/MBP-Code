function [bands_lo,bands_hi,MI,MI_p_vals,MI_z_scores,MI_lz_scores,MI_p_thresh,MI_z_thresh,MI_lz_thresh,MI_npv,MI_lpv]=CFC_September_wav(datafile,sampling_freq,nobins,noshufs,threshold,bands_lo,bands_hi,units,outfilename,dirname)
...
inv_entropy_bMI_all(MI,F_lo,F_hi,50,'linear',units,dataname);
