function fbank_sim_analysis_reflect
...
%             tic;
            ...
            [bands,MI(:,:,1),MI(:,:,2),MI(:,:,3),nMI(:,:,k,1),nMI(:,:,k,2),nMI(:,:,k,3)]=CFC_April_fbank_beta(char(filenames(k)),600,5,10,20,100,.05,.05,[3 9],15,[20 110],15,0,.9,divisor,'Hz',dirnames);
