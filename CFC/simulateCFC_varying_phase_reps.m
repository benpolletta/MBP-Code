function simulateCFC_varying_phase_reps(simlength,sampling_freq,f_lo,f_hi,df_lo,da,strength,noise_level,reps)
...
for i=1:reps
    ...
    filename=['simCFC_a_',num2str(f_hi),'_p_',num2str(f_lo),'pm',num2str(df_lo),'_strength_',num2str(strength),'_da_',num2str(da),'_rep',num2str(i)];
