function [mean_wt_power, mean_wt_phase, mean_peak_segments, total_peaks] = peak_averaged_wt_batch_condition_parallel(conditions_name, peak_freq, peak_freq_cycles, sampling_freq)
