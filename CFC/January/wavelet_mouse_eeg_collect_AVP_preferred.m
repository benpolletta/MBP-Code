function [AVP_all]=wavelet_mouse_eeg_collect_AVP_preferred(epoch_list,condition_dirs,norm_flag)
...
if norm_flag==1
    ...
    fid_AVP=fopen([all_dirname,'/',all_dirname,'_AVP_pref_norm.txt'],'w');

else
   
    fid_AVP=fopen([all_dirname,'/',all_dirname,'_AVP_pref.txt'],'w');
...
if norm_flag==1
    ...
    save([all_dirname,'/',all_dirname,'_AVP_pref_norm.mat'],'AVP_all','PAC_params')

else
    
    save([all_dirname,'/',all_dirname,'_AVP_pref.mat'],'AVP_all','PAC_params')
