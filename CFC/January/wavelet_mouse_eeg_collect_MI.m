function [MI_all]=wavelet_mouse_eeg_collect_MI(epoch_list,condition_dirs)
...
format=make_format(noamps*nophases,'s');
...
for j=1:no_epochs
    ...
    if epoch_state<3
        ...
        fprintf(fid_vec(1),format,[j epoch_state MI]);
        ...
        fprintf(fid_vec(2),format,[j epoch_state canMI]);
        ...
        fprintf(fid_vec(3),format,[j epoch_state PLV]);
