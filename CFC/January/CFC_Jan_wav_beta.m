...
[f,data_hat,bands_lo,H_lo,A_lo,P_lo]=filter_wavelet_Jan(data,'fs',sampling_freq,'filename',[dataname,'_lo'],'bands',bands_lo);
[f,data_hat,bands_hi,H_hi,A_hi,P_hi]=filter_wavelet_Jan(data,'fs',sampling_freq,'filename',[dataname,'_hi'],'bands',bands_hi);
