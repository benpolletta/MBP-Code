function emd_bMI_plotter(challenge_list,challenge_name,challenge_descriptor,challenge_params,challenge_labels)
...
for i=1:listnum
    ...
    [All_bMI,avg_bMI]=batch_bMI(listname,4,'MI_Data_Plots','HAF_Data_Plots',[3 9],15,[20 110],15,'Hz');
