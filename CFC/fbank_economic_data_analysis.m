function fbank_economic_data_analysis

challenge_list='Dow_Jones_list.list';
...
for m=1:2
    ...
    for j=1:no_challenges
        ...
        max_nMI_bands=zeros(filenum,2,no_challenges,2);
        ...
        for k=1:filenum
            ...
            [bands,MI(:,:,1),MI(:,:,2),MI(:,:,3),nMI(:,:,k,1),nMI(:,:,k,2),nMI(:,:,k,3)]=CFC_April_fbank_beta(char(filenames(k)),1,5,10,20,100,.05,.05,[1 10]*.005,10,[1 24]*.02,24,0,.9,divisor,'Hz',dirnames);
