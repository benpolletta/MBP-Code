function [f,data_hat,bands,signals,H,A,P,F,cycle_bounds]=filter_fft_filtfilt(data,varargin)
...
%         signals(:,j)=real(ifft(filtered));
        ...
        signals(:,j)=filtfilthd(h,data,'reflect');
