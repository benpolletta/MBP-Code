function [M,MI]=CFC_He_fft(datafile,sampling_freq,range_lo,range_hi,nobands_lo,nobands_hi,nobins,dataname,signal)
...
[f,data_hat,bands_lo,signals_lo,A_lo,P_lo,Pmod_lo]=plotfft_fancy(data,'fs',sampling_freq,'spacing',signal,'filename',[dataname,'_lo'],'bandranges',range_lo,nobands_lo);
[f,data_hat,bands_hi,signals_hi,A_hi,P_hi,Pmod_hi]=plotfft_fancy(data,'fs',sampling_freq,'spacing',signal,'filename',[dataname,'_hi'],'bandranges',range_hi,nobands_hi);
