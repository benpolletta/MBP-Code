function [max_data_all,data_all]=figure_replotter_labels(numbers,rows,cols,x_ticks,y_ticks,titles,x_labels,y_labels)
...
x_dim=length(x_ticks);
y_dim=length(y_ticks);
