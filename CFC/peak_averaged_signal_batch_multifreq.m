function [mean_peak_segments,se_peak_segments]=peak_averaged_signal_batch_multifreq(peak_freq,target_freq,sampling_freq)
...
%         signal_length=length(data);
    ...
    mean_peak_segments(1:segment_length,j)=mean(Peak_segments)';
