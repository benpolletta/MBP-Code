function wav_inv_entropy_colorplot_no_thresh(MI,MI_p_vals,MI_p_thresh,MI_z_scores,MI_z_pvals,MI_z_thresh,MI_lz_scores,MI_lz_pvals,MI_lz_thresh,threshold,filename,A_bands,P_bands,units)
