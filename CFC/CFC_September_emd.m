function [bands,MI,MI_p_vals,MI_z_scores,Binned_MI,Binned_MI_pt,Binned_MI_zt]=CFC_September_emd(datafile,sampling_freq,min_cycles,nobins,noshufs,p_threshold,z_threshold,x_lims,x_bins,y_lims,y_bins,spacing,units,outfilename,extradirname)
