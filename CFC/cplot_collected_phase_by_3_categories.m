function cplot_collected_phase_by_3_categories(Title,name,freqs,bands,band_names,stops,c_order,cat3_labels,cat1_labels,cat2_labels,cat3_vec,cat1_vec,cat2_vec,spec)
